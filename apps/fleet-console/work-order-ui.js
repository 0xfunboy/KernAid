export const workOrderActions = Object.freeze({
  ...
  "linux.crypttab.disable-missing-uuid.v1": Object.freeze({
    label: "Repair missing crypttab UUID",
    version: 1,
    kind: "repair",
    risk: "R2",
    requiredFeature: "enterprise_repair",
  ...
  "linux.ext4.fsck-preen-with-undo.v1": Object.freeze({
    label: "Repair ext4 offline with undo",
    version: 1,
    kind: "repair",
    risk: "R3",
    requiredFeature: "enterprise_repair",
  ...
  "linux.network.restore-resolver-link.v1": Object.freeze({
    label: "Restore resolver link",
    version: 1,
    kind: "repair",
    risk: "R2",
    requiredFeature: "enterprise_repair",
