...
di sanitizzazione dell'intero supporto. Il catalogo v2 distribuito, revisione 5,
...
scaricabile. Il catalogo v2 ha `catalogRevision: 5` e autorizza esclusivamente
`KernAid-Rescue-amd64.iso`, versione artefatto `ci-33259104331-1`, di
`1,223,540,736` byte e SHA-256
`3df9a44f0c8b992f583b887fb10636a41fa7fae7bc4a2dc6284aa34ffcfc0c28`,
costruita dal commit `29830e853650753e2efdfa0027c51eea68827af3` nel run
GitHub Actions `33259104331` e selezionata per la release interna
`0.1.0-internal.3`. Lo stesso artefatto ha superato le prove QEMU
...
l'esatta ISO autorizzata dalla revisione 5; ogni altra immagine viene rifiutata
...
revisione 5 e resta limitata alla prima qualifica fisica controllata descritta
...
candidata della revisione 5; recovery autenticata e rollback restano gate
...
## Writer USB v2 e vault cifrato (implementato, catalogo revisione 5)
...
core. Con la revisione 5 il comando seguente accetta soltanto l'ISO esatta
