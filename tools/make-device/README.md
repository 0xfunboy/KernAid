...
di sanitizzazione dell'intero supporto. Il catalogo v2 distribuito, revisione 8,
...
scaricabile. Il catalogo v2 ha `catalogRevision: 8` e autorizza esclusivamente
`KernAid-Rescue-amd64.iso`, versione artefatto `ci-33330139973-1`, di
`1,223,540,736` byte e SHA-256
`fe8d54d8e154f6a4712c65855b5dffdcb31dddeac0d3a03c299d606f87a16000`,
costruita dal commit `5db47001fad2a3814d90837bcdcea545b2da0fa9` nel run
GitHub Actions `33330139973` (attempt 1) e pubblicata come sequenza 6 della
release interna `0.1.0-internal.6`. Lo stesso artefatto ha superato le prove QEMU
...
l'esatta ISO autorizzata dalla revisione 8; ogni altra immagine viene rifiutata
...
revisione 8 e resta limitata alla prima qualifica fisica controllata descritta
...
candidata della revisione 8; recovery autenticata e rollback restano gate
...
## Writer USB v2 e vault cifrato (implementato, catalogo revisione 8)
...
core. Con la revisione 8 il comando seguente accetta soltanto l'ISO esatta
